  ...
  // ============================================================
  {
    ...
    escenas: {
      ...
      escena_callejon: {
        ...
        opciones: [
          { txt: 'Estudiar cómo le extrajeron los implantes', va:'escena_callejon', cuesta:true, da:'extraccion_torpe', msg:'Los cortes son feos, apresurados, hechos con herramienta de chatarrero, no de cirujano ni de sicario. Una facción que mata por encargo deja un cadáver limpio, un mensaje. Esto es otra cosa: alguien abrió a Deji con prisa y miedo, para llevarse las piezas antes de que llegara nadie. No es un asesinato con firma. Es un saqueo.' },
