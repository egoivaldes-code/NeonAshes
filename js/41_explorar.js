...
const _EXP_IMGS_GENERICAS = [
  ...
  'EXP_ALMACEN_HELIX', 'EXP_GUARIDA_ECO', 'EXP_PLANTA_AGUA',
  'EXP_CALLEJON_NIVELES', 'EXP_CIBERCAFE', 'EXP_ALMACEN_OKUPA',
  'EXP_COMEDOR_SECTORB', 'EXP_SANTUARIO_ECO', 'EXP_CALLEJON_SUENOS',
  'EXP_PLAZA_OLVIDADOS', 'EXP_ALMACEN_ZONA7',
  // — fondos nuevos v0.162 (deriva + zonas) —
  'DERIVA_LLUVIA_INTENSA', 'DERIVA_MADRUGADA', 'DERIVA_APAGON', 'DERIVA_CANAL_NOCHE', 'DERIVA_PLAZA_VACIA_MEGAFONIA', 'DERIVA_MERCADO_CERRANDO', 'DERIVA_COLA_RACION', 'DERIVA_PASARELA_INDUSTRIAL', 'DERIVA_CONTROL_HELIX', 'DERIVA_AZOTEA_TENDEDEROS', 'CARMESI_CALLE', 'CARMESI_INTERIOR', 'FERRO_ACERIA', 'FERRO_TALLER', 'NODO_IA_SERVIDORES', 'SANTUARIO_INTERIOR', 'HELIX_REGULARIZACION', 'PLANTA_PROCESADO',
  // — v0.163 (tanda D) —
  'TRATO_INTERIOR_01', 'TRATO_INTERIOR_02', 'CONFRONTACION_CALLEJON',
  'TREN_ANDEN', 'CIUDAD_DISTURBIOS', 'CIUDAD_TOQUE_QUEDA'
];
...
const _EXP_IMGS_POR_TEMA = {
  mercado: ['MARKET_DISTRICT_TIER1', 'SECTOR7_BLACK_MARKET',
    'EXP_TALLER_PROTESIS_1', 'EXP_MERCADO_OLVIDADOS', 'EXP_MERCADO_SUMERGIDO',
    'EXP_TALLER_REUTILIZA', 'EXP_TALLER_NEURAL'],
  medico:  ['HELIX_MEDICAL_CENTER', 'TREATMENT_WING',
    'HOSPITAL_CONSULTA', 'HOSPITAL_ESPERA', 'HOSPITAL_BOX'],
  muelle:  ['DOCK_ACCESS_TUNNEL', 'FREIGHT_HUB07', 'LOWER_CANAL_SECTOR7B',
    'EXP_PUERTO_ORBITAL_1', 'EXP_PUERTO_ORBITAL_2', 'EXP_PUERTO_CARGA',
    'EXP_CANAL_PILAS']
};
