...
const RUMORES = [
  ...
  { npc:'hermana_lia', faccion:'eco', signo:'neg',
  ...
  // ── Tanda v0.100: más boca a boca, con ganchos al mundo ─────
  { npc:'rasha', faccion:'sindicatos', signo:'neg',
    txt:'En el puerto del Ferro contaron muertos toda una semana. Don Vasek sigue cortando fruta como si nada. Dicen que esos son los que más cortan.' },
  { npc:'hermana_lia', faccion:'eco', signo:'pos',
    txt:'En el Santuario IX curan lo que HELIX cobra. Algunos salen andando de ahí. Lo que no cuentan es qué dejan dentro a cambio.' },
  { npc:'hermana_lia', faccion:'eco', signo:'neg',
    txt:'Dicen que en el Santuario hay un hermano que vende la gracia en parches, a espaldas de la Hermana. Ella reza. Él cobra. Vaya par.' },
  { npc:'doc_varga', faccion:'', signo:'neg',
    txt:'No vayas al ala sin número del hospital, la que no sale en los carteles. Cuentan que entra gente sin reclamar y salen bandejas con código de barras.' },
  { npc:'cero_ocho', faccion:'ia', signo:'neg',
    txt:'Un sector entero de los bajos lleva años sellado. Los pocos que bajaron dicen que algo late ahí abajo, cada once segundos, y que te llama por un nombre que no recuerdas tener.' },
  { npc:'', faccion:'loto', signo:'neg',
    txt:'En el Arrabal aparecen cuerpos vaciados de implantes, abiertos con prisa. La Mano Roja jura que no es cosa suya. Por una vez, igual dice la verdad.' },
  { npc:'capitana_vey', faccion:'drifters', signo:'neg',
    txt:'Una piloto se fue de las Pilas y no volvió. Unos dicen que encontró la salida. Otros, que la salida la encontró a ella.' },
  { npc:'', faccion:'', signo:'',
    txt:'Hay un investigador por los niveles que cobra poco y pregunta mucho. Dicen que encuentra lo que nadie quiere encontrado. Ándate con ojo con lo que le cuentas.' },
  { npc:'', faccion:'helix', signo:'neg',
    txt:'HELIX subió otra vez las listas de espera del hospital. Y, casualidad, bajó el precio de los implantes de segunda mano en el Arrabal. Ata cabos tú.' },
  { npc:'', faccion:'', signo:'',
    txt:'Un viejo paga el alquiler de un piso vacío en las capas medias desde que enviudó. Ni roba ni esconde nada. Solo no quiere irse del todo. Eso, aquí, es casi un milagro.' },
  { npc:'', faccion:'', signo:'',
    txt:'Cuentan que en una clínica popular hay una enfermera que llama a los pacientes por el nombre de gente que ya no viene. A veces uno le sigue la corriente. A veces ella lo sabe y lo agradece.' },
  { npc:'', faccion:'sindicatos', signo:'pos',
    txt:'Si el Ferro te marca con su sello, las fundiciones te abren la puerta. Lo que no te dicen es lo que hay que hacer para ganárselo. Pregunta a los que ya no duermen.' },
